...
localize_strings = {
    'ko_KR' : {
        ...
        'cancelling' : "취소 중...",
        'cancelled' : "작업 취소됨",
        'translate_filenames' : "파일명도 번역 (일본어 → 타깃 언어)",
        'translating_filenames' : "파일명 번역 중...",
        'selectfile' : "파일 열기",
        ...
        'multifile_instruction' : "파일이나 폴더를 아래 상자에 드래그 & 드랍하거나, '파일 추가' / '폴더 추가' 버튼을 사용하세요. 폴더는 하위 폴더까지 재귀적으로 모든 미디어 파일을 추가합니다.",
        'add_file' : "파일 추가",
        'add_file_dialog_title' : "추가할 미디어 파일 선택 (여러 개 선택 가능)",
        'add_folder' : "폴더 추가",
    ...
    'base' : {
        ...
        'cancelled' : "Cancelled",
        'translate_filenames' : "Translate filenames (Japanese → target lang)",
        'translating_filenames' : "Translating filenames...",
        ...
        "length": "Length",
        "status": "Status",
        "multifile_instruction": "Drag & drop files or folders onto the box below, or use the 'Add File' / 'Add Folder' buttons. Folders are imported recursively, including every media file in sub-folders.",
        'add_file' : "Add File",
        'add_file_dialog_title' : "Select media file(s) to add (multiple allowed)",
